              ...
              <tbody>
                <tr style="font-family: Helvetica, Arial, sans-serif;">
                  <td style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding: 25px 0 25px; text-align: center;">
                    <strong style="font-family: Helvetica, Arial, sans-serif;"><?= getStoreSettings('store_name') ?></strong><br style="font-family: Helvetica, Arial, sans-serif;"> <?= getStoreSettings('contact_address') ?>
