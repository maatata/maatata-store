<div ng-controller="UploadManagerDialogController as uploadDialogCtrl" class="lw-dialog">
    ...
    <div class="lw-section-heading-block">
        <h3 class="lw-header"> <?= __("Upload Manager") ?></h3>
    </div>
    <!-- /main heading -->
    <div class="alert alert-info"><strong><?= __(" Note :") ?> </strong><?= __("Please double click on image/document for selection.") ?></div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr ng-repeat="file in uploadDialogCtrl.files track by $index">
                    ...
                    <td>
                        <a href="" ng-click="uploadDialogCtrl.delete(file.name)" title="<?=  __('Delete')  ?>"><i class="fa fa-trash fa-1x"></i></a>
                    </td>
                </tr>
            </tbody>
    ...
    <div class="form-group">
        <label class="control-label"><?=  __("Uploads")  ?></label>
        <div>
